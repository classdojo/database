  ...
  Db = (function() {
    ...
    */
    ...
    function Db(schemaPath, dbSettingsPath) {
      ...
      this.__dbSettingsPath = dbSettingsPath;
      this.__files = {};
    }
    ...
    */
    ...
    Db.prototype.init = function() {
      this.__nodeBuilder = new ModelNodeBuilder(this.__schemaPath);
      this.__nodeBuilder.init();
      this.__nodeManager = new NodeManager();
      this.__dbBuilder = new MongooseB(this.__nodeBuilder, this.settings);
      return this;
    };
    ...
    */
    ...
    Db.prototype.__defineGetter__('settings', function() {
      ...
      return this.__files.settings || (this.__files.settings = (function() {
        return require(_this.__dbSettingsPath).init(process.env.NODE_ENV);
      })());
    });
